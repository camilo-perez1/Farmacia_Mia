        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="card card-success card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b style="color:#0B7300">Codigo</b> <a class="float-right">12</a>
                  </li>
                  <li class="list-group-item">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">bello horizonte</p>
                <strong style="color:#0B7300">
                  <i class="fas fa-at mr-1"></i> Correo
                </strong>
                <p class="text-muted">Ejemplo123@gmail.com</p>
                <strong style="color:#0B7300">
                  <i class="fas fa-smile-wink mr-1"></i> Sexo
                </strong>
                <p class="text-muted">424534543</p>
                <strong style="color:#0B7300">
          ...
          <div class="col-md-9">
            <div class="card card-success">
              ...
              <div class="card-body">
                <form action="/actualizar_datos" method="post" class="form-horizontal">
                  <div class="form-group row">
                    <label for="telefono" class="col-sm-2 col-form-label">Telefono</label>
                    <div class="col-sm-10">
                      <input type="number" id="telefono" class="form-control" placeholder="Ingrese su telefono" name="telefono" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="Residencia" class="col-sm-2 col-form-label">Residencia</label>
                    <div class="col-sm-10">
                      <input type="text" id="Residencia" class="form-control" placeholder="Ingrese su direccion" name="residencia" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="Correo" class="col-sm-2 col-form-label">Correo</label>
                    <div class="col-sm-10">
                      <input type="email" id="Correo" class="form-control" placeholder="Ingrese su Correo" name="correo" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="Sexo" class="col-sm-2 col-form-label">Sexo</label>
                    <div class="col-sm-10">
                      <input type="text" id="Sexo" class="form-control" placeholder="Ingrese su Genero" name="sexo" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="Adicional" class="col-sm-2 col-form-label">Adicional</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" id="adicional" cols="30" rows="10" name="adicional"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
